...
SELECT * FROM sales.customers -- (91 rows affected)
SELECT * FROM hr.employees    -- ( 9 rows affected)
...
--range
SELECT DATEADD(day, n-1, CAST('20170101' AS DATE)) AS orderdate
FROM dbo.Nums
WHERE n <= DATEDIFF(day, '20170101', '20191231') + 1
ORDER BY orderdate;

--order placed in date
SELECT DATEADD(day, Nums.n - 1, CAST('20170101' AS DATE)) AS orderdate,
  O.orderid, O.custid, O.empid
FROM dbo.Nums
  LEFT OUTER JOIN Sales.Orders AS O
    ON DATEADD(day, Nums.n - 1, CAST('20170101' AS DATE)) = O.orderdate
WHERE Nums.n <= DATEDIFF(day, '20170101', '20191231') + 1
ORDER BY orderdate;
